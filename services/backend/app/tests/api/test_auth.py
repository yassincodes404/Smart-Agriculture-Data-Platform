...
class TestLogin:
    ...
    def test_seeded_local_admin_email_can_login(self, client, db_session):
        """Seeded admin accounts use .local emails and must be able to log in."""
        admin = User(
            email="admin2@agri.local",
            password_hash=security.hash_password("SuperAdmin456"),
            role="admin",
            is_active=True,
        )
